...
export const metadata: Metadata = {
  title: "Privacy Policy | Bernzz Digital Solutions",
  description:
      ...
      <section className="relative pb-10">
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-4 text-2xl gap-2 font-bold tracking-tight text-slate-900 dark:text-slate-50 md:text-4xl">
              Privacy
              <span className="bg-clip-text text-black">Policy</span>
            </h1>
              ...
              {dataTypes.map((type, index) => (
                <Card
                  ...
                  <CardContent className="p-6">
                    <div
                      className={`inline-flex rounded-lg p-3 group-hover:scale-110 transition-transform`}>
      ...
      <section className="py-16">
        <div className="container">
          <div className="mx-auto max-w-4xl">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                          {[
                            ...
                            <div
                              ...
                              <div className="mt-1 h-2 w-2 rounded-full"></div>
            ...
            <Card className="mt-12 text-white">
              <CardContent className="p-8">
                <div className="text-center">
                  <HelpCircle className="mx-auto mb-4 h-12 w-120" />
                  ...
                  <div className="space-y-2">
                    <p className="text-slate-300">
                      ...
                      privacy@bernzzdigitalsolutions.co.ke
                    </p>
                    <p className="text-slate-300">
