...
export const metadata: Metadata = {
  title: "About Us | Bernzz Digital Solutions",
      ...
      <section className="relative py-10 md:py-20">
        <div className="container px-4 sm:px-4">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <h1 className="mb-3 text-3xl font-semibold tracking-tight text-black lg:text-2xl">
                ...
                <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
                  ...
                  <div className="flex items-center justify-center">
                    <div className="grid grid-cols-2 gap-6">
                      <div className="rounded bg-white/80 p-8 text-center ">
            ...
            <Card className=" shadow-2xl">
              <CardContent className="p-12 md:p-16 lg:p-20">
                <div className="text-center">
                  ...
                  <h2 className="mb-8 text-3xl font-semibold md:text-2xl">
                    Our Team
                  </h2>
                  <p className="text-lg leading-8 md:text-xl md:leading-9">
