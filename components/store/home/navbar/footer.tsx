...
import { Category } from "@/lib/product/product.types";
...
export const socials = [
  {
    ...
    link: "https://www.facebook.com/BDStechnologies",
  },
  {
    name: "Instagram",
    icon: (
    ...
    link: "https://www.instagram.com/bernzztechnologies",
  },
  {
    name: "Twitter",
    icon: (
  ...
  },
  {
    ...
    link: "https://www.tiktok.com/@eunicepeters4",
  },

  {
    ...
    link: `https://wa.me/${WhatsappPhoneNumber}`,
  },
];
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div>
            <Link href="/" className="text-xl font-bold text-gray-900">
              Bernzz Digital Solutions
            </Link>
            <p className="mt-4 text-sm">
              Discover laptops, smartphones, TVs, appliances, accessories, and
              more — all at unbeatable prices. We deliver anywhere in Kenya and
              guarantee genuine products with warranty.
            </p>
          </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-2 flex gap-2">
                <Input
                  ...
                  className="w-full rounded-sm border border-black bg-white px-3 py-1 text-sm"
                />
                <Button className="w-40 bg-black text-white border border-black hover:bg-white hover:text-black rounded-sm">
                  Subscribe
                </Button>
              </div>
            </div>
