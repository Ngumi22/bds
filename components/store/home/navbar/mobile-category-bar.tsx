    ...
    <div
      ...
      <div className="container px-0 relative">
        {showLeftScroll && (
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-0 bottom-0 z-10 px-1 flex items-center justify-center bg-linear-to-r from-background to-background/80"
        ...
        {showRightScroll && (
          <button
            onClick={scrollRight}
            className="absolute right-0 top-0 bottom-0 z-10 px-1 flex items-center justify-center bg-linear-to-l from-background to-background/80"
