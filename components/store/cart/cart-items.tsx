  ...
  return (
    <div className="space-y-6">
      {items.length === 0 ? (
        ...
        <>
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 bg-linear-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-sm border border-blue-200/50 dark:border-blue-800/50">
            <div>
