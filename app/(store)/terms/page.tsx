  ...
  const termsSections = [
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-950/20">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              ...
              constitute a legally binding agreement between you and Bernzz
              Digital Solutions.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div className="flex">
              ...
              <span className="text-sm text-slate-600 dark:text-slate-300">
                Refers to Bernzz Digital Solutions
              </span>
            </div>
            <div className="flex">
              <span className="font-mono text-sm font-bold text-blue-600 dark:text-blue-400 w-24">
              ...
              <span className="text-sm text-slate-600 dark:text-slate-300">
                Refers to bernzzdigitalsolutions.co.ke
              </span>
            </div>
            <div className="flex">
              <span className="font-mono text-sm font-bold text-blue-600 dark:text-blue-400 w-24">
      ...
      content: (
        <div className="space-y-4">
          <p className="text-slate-600 dark:text-slate-300">
            ...
            graphics, logos, images, and software, is the property of Bernzz
            Digital Solutions and is protected by intellectual property laws.
          </p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-slate-600 dark:text-slate-300">
            To the fullest extent permitted by law, Bernzz Digital Solutions
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2 text-sm">
            <p className="text-slate-900 dark:text-slate-50">
              ...
              legal@bernzzdigitalsolutions.co.ke
            </p>
            <p className="text-slate-900 dark:text-slate-50">
              <span className="font-medium">Phone:</span> +254 (112) 725-364
            </p>
            <p className="text-slate-900 dark:text-slate-50">
